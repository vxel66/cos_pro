...
class Solution5 {
    public int[] solution(int N, int[] votes) {
        ...
        for (int i = 1; i <= N; i++) {
            ...
            System.out.println("voteCounter: "+voteCounter[i]);
        }
    ...
    public static void main(String[] args) {
        ...
        System.out.println("이민욱_1차_1급.Solution: return value of the method is " + Arrays.toString(ret1) + " .");
        ...
        // Press Run button to receive output. 
        System.out.println("이민욱_1차_1급.Solution: return value of the method is " + Arrays.toString(ret2) + " .");
    }
}